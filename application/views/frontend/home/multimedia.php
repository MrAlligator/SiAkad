<section class="sample-text-area">
    <div class="container">
        ...
        <p class="text-justify" style="font-family:Arial">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Multimedia secara utuh berarti kombinasi atau penggabungan dari beberapa media seperti teks, audio, video, animasi, gambar yang disajikan dalam penggunaan komputer dengan bantuan tool dan link sehingga menghasilkan presentasi yang menarik.
            Kategori dalam multimedia terdapat 2 macam, yaitu Multimedia Communication dan Multimedia Content Production. Pengertian dari Multimedia Communication adalah penggunaan media yang memiliki fungsi mempublikasikan informasi. Dalam kategori ini media yang digunakan adalah TV, Radio, Film, Game, Musik, Entertaiment, Tutorial, Internet, dan Media Cetak.</p>
        <p class="text-justify" style="font-family:Arial">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Dengan adanya multimedia communication ini akan mempermudah penggua dalam menyampaikan dan mendapatkan informasi. Selanjutnya Multimedia Content Production adalah penggunaan beberapa media yang berbeda seperti Teks, Animasi, Audio, Video, gambar (grafik) yang dipadukan
    ...
    <div class="container">
        ...
        <div class="">
            <ul class="unordered-list">
                ...
                <li style="font-family:Arial">
                    <p>Media Efek Khusus (Special Effect)
                </li>
                <li style="font-family:Arial">
                    <p>Media Interaktif (Interactivity)
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="whole-wrap">
        <div class="container">
            ...
            <div class="">
                <ul class="unordered-list">
                    <li style="font-family:Arial">
                        <p>Dasar-dasar multimedia
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Pengenalan dan Perakitan PC
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Etimologi Multimedia
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Fotografi dan Teknik Pengambilan Gambar
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Belajar Animasi Dasar
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Alir Produksi Multimedia
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Pengelolaan Web
                    ...
                    <li style="font-family:Arial">
                        <p>Audio dan Video Editing
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Menggambar Clean-up dan Sisip
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Perawatan peralatan multimedia
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Proposal pembuatan produk
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Seni Grafis dan Gambar 2D
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Stop Motion
                    ...
                    <li style="font-family:Arial">
                        <p>Pembuatan Story Board
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Instalasi Sistem Operasi Dasar
                    </li>
                    </p>
                    <li style="font-family:Arial">
                        <p>Final Project (Proyek Akhir pembuatan produk multimedia)
                    </li>
                    </p>
                </ul>
            </div>
